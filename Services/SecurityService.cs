...
namespace EpmDashboard
{
    public partial class SecurityService
    {
        ...
        private readonly EPMContext _epmContext;
        public ApplicationUser User { get; private set; } = new ApplicationUser { Name = "Anonymous" };
        
        
        public ClaimsPrincipal Principal { get; private set; }

        public SecurityService(NavigationManager navigationManager, IHttpClientFactory factory, EPMContext epmContext)
        {
            this.baseUri = new Uri($"{navigationManager.BaseUri}odata/Identity/");
            this.httpClient = factory.CreateClient("EpmDashboard");
            this.navigationManager = navigationManager;
            _epmContext = epmContext;
        }
