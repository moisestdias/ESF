...
namespace EpmDashboard.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<EpmDashboard.Models.ApplicationUser> users;
        protected RadzenDataGrid<EpmDashboard.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(EpmDashboard.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(EpmDashboard.Models.ApplicationUser user)
        {
            try
            {
