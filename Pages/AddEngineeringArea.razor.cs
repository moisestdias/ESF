...
{
    public partial class AddEngineeringArea
    {
        [Inject]
        ...
        {
            engineeringArea = new EpmDashboard.Models.EPM.EngineeringArea();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await EPMService.CreateEngineeringArea(engineeringArea);
